...
import { type UserPreferences, type PreferencesFormData, type CookingFrequency } from '../../types/prefs';
...
const FREQUENCY_OPTIONS: { value: CookingFrequency; label: string; description: string }[] = [
  {
    value: 'daily',
    label: 'Every day',
